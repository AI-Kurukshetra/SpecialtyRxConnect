          ...
          <Card className="p-6">
            ...
            <div className="mt-5 space-y-4">
              {data.outreachQueue.map((item) => (
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4" key={`${item.recipient}-${item.scheduledFor}`}>
          ...
          <Card className="p-6">
            ...
            <div className="mt-5 space-y-4">
              {data.activityLog.map((item) => (
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4" key={`${item.timestamp}-${item.title}`}>
